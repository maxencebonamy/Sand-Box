...
1. Click on the <a href="https://github.com/maxencebonamy/Sand-Box/releases">Releases</a> button on the right and select the **latest version**.
...
*Prerequisites :*
*- Git must be installed on your computer. If not, <a href="https://git-scm.com/downloads">click here.</a>*
*- Xmake must be installed on your computer, if not, <a href="https://xmake.io/#/getting_started?id=installation">click here.</a>*
